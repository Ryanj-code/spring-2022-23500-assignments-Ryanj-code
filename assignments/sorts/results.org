Observations from testing sorts:
  ...
  took longer than the merge sort later on. The in-place quick sort with good pivot stayed fast and was quicker than both the other two sorts from smaller sizes 
  to bigger sizes.
